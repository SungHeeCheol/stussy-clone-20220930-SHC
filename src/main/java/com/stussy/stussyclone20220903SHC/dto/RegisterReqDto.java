...
import com.stussy.stussyclone20220903SHC.dto.validation.ValidationGroups;
import lombok.Data;
...
public class RegisterReqDto {
    // 한글자 이상 무조건 들어와야함, 세글자를 넘을 수 없다. 무조건 한글이어야 한다.
    ...
    @Pattern(regexp = "^[가-힇]{1,3}$", message = "한글만 입력가능합니다", groups = ValidationGroups.PatternCheckGroup.class)
    ...
    @Size(min = 8, max = 16, message = "비밀번호는 8자리부터 16자리까지 입력해야합니다", groups = ValidationGroups.SizeGroup.class)
    @Pattern(
