...
class RegisterService{
    ...
    getCategoryList(){
        ...
        const porductCategoryList = commonApi.getCategoryList(); //commonApi안에 있는 getCategoryList로 ajax로 들고온 데이터 호출
        
        const porductCategory = document.querySelector(".product-category");
        porductCategory.innerHTML = '<option value="none">상품 종류</option>';
        porductCategoryList.forEach(category => {
            porductCategory.innerHTML += `
